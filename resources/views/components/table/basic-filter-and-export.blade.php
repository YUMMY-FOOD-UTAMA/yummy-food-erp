                    ...
                    <div class="px-7 py-5">
                        <div class="d-flex align-items-center position-relative my-1 mb-4">
                            ...
                            <input type="text" data-kt-customer-table-filter="search" name="search_keyword"
                                class="form-control form-control-solid ps-15" value="{{ request()->search_keyword }}"
                                id="search_keyword" placeholder="Search {{ $name }}" />
                        </div>
                        {{ $slotFilterForm ?? '' }}
                        <div class="d-flex justify-content-end">
                            <button type="reset" class="btn btn-light btn-active-light-primary me-2"
                                data-kt-menu-dismiss="true" id="resetButton" data-kt-customer-table-filter="reset">Reset
                            </button>
