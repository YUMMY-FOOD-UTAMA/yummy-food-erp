<div class="card card-flush overflow-hidden h-lg-100">
    ...
    <div class="card-header pt-5">
        ...
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold text-dark">Schedule Visit</span>
    ...
    <div class="card-body d-flex align-items-end p-0">
        <!--begin::Chart-->
        <div id="schedule_visit_chart" class="min-h-auto w-100 ps-4 pe-6" style="height: 300px"></div>
        <!--end::Chart-->
    </div>
    <!--end::Card body-->
</div>
@push('script')
    <script>
        var element = document.getElementById("schedule_visit_chart");
