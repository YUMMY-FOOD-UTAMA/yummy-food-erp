...
<div class="card card-flush overflow-hidden h-lg-100">
    <div class="card-header pt-5">
        ...
        <x-modal id="viewTableChartTransaction"
                 title="Data Sales Target vs Sales Real" size="1000">
            <table class="table data-table align-middle table-row-dashed fs-6 gy-3">
                ...
                @foreach ($dataDummy as $data)
                    @php
                        $selisih = $data['salesReal'] - $data['salesTarget'];
                    @endphp
                    <tr>
                        <td>
                            {{ $data['date'] }}
                        ...
                        <td>
                            {{ number_format($data['salesTarget'], 0, ',', '.') }}
                        </td>
                        <td>
                            {{ number_format($data['salesReal'], 0, ',', '.') }}
                        </td>
                        <td>
...
@push('script')
    <script>
        ...
        var categories = [
            '01/09/24', '02/09/24', '03/09/24', '04/09/24', '05/09/24', '06/09/24', '07/09/24'
        ];
