...
<div class="container">
    ...
    <div class="content">
        <p style="font-size: 22px; font-weight: 700; color: #181C32;">Verify your email address!</p>
        <p style="color: #7E8299;">Thank you for signing up. Please confirm your email address to activate your
            account.</p>
        <p style="color: #7E8299;">Click the button below to verify your email:</p>
        <a href="{{$url}}" class="button"
           style="background-color: #50cd89; color: #ffffff; text-decoration: none; padding: 11px 19px; border-radius: 6px; font-size: 14px; font-weight: 500;">Verify
            Email</a>
        <br>
    </div>
    <div class="footer">
