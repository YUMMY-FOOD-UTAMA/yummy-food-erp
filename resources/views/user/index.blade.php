...
@section('content')
    <x-general-section-content>
        ...
        @endslot
        <div class="card">
            <x-table.advance-filter :usingApplyButton="true" />
            <x-table.basic-filter-and-export name="User" exportRoute="as">
                @slot('slotFilterForm')
                    <x-form.select-box-geographic province-i-d="{{ request()->province_id }}" form-method="GET"
                        type="vertical"></x-form.select-box-geographic>
                @endslot
                @slot('slotFilterExport')
                    <x-form.select-box-geographic type="vertical"></x-form.select-box-geographic>
                @endslot
