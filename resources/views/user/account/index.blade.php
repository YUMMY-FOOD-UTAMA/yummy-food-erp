...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        @include('user.account.layout.breadcumb')
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span class="fw-bold fs-6 text-gray-800">{{Auth::user()->subDistrict?->name ?? '-'}}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            <label class="col-lg-4 fw-semibold text-muted">Village</label>
                            <div class="col-lg-8">
                                <span class="fw-bold fs-6 text-gray-800">{{Auth::user()->subDistrictVillage?->name ?? '-'}}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
