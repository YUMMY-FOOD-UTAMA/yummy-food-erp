<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo" style="background-color: #C3252B !important;">
        ...
        <div id="kt_app_sidebar_toggle"
             class="app-sidebar-toggle btn btn-icon btn-shadow btn-sm btn-color-muted btn-active-color-primary body-bg h-30px w-30px position-absolute top-50 start-100 translate-middle rotate {{request()->is('receivable/entry/invoice*') ? 'active' : ''}}"
                ...
                @if(Auth::user()->hasPermissionStartingWith('receivable.'))
                    ...
                    <span class="menu-link">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            {{-- receivalbe entry --}}
                            @if(Auth::user()->hasPermissionStartingWith('receivable.entry.'))
                                <div data-kt-menu-trigger="click"
                                     class="menu-item menu-accordion {{Route::is('receivable.entry.*')?'show':''}}">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <i>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                                        ...
                                        <span class="menu-title">Receivable Entry</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        @can('receivable.entry.invoice.index')
                                            <div class="menu-item">
                                                <a class="menu-link {{Route::is('receivable.entry.invoice.*')?'active':''}}"
                                                   href="{{route('receivable.entry.invoice.index')}}">
                                                    <span class="menu-icon">
                                                        <i>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                 height="16"
