...
<body>
    <table class="table-header" style="margin-bottom: 1rem;">
        <tr>
            <td><span style="font-weight: bold;">PT. YUMMY FOOD UTAMA 2024</span><br>Jl. Raya Bogor No. 40 Kec. Ciracas,
                Jakarta 13750<br>indonesia
            </td>
            <td colspan="2" style="font-weight: bold; font-size: 20px; vertical-align: top;">INVOICE
            </td>
            <td></td>
            <td></td>
        </tr>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th class="min-w-80px" style="text-align: center;">Delivery Note<br>Number</th>
                <th class="min-w-80px" style="text-align: center;">Buyer Order<br>Number</th>
                <th class="min-w-80px" style="text-align: center;">Delivery<br>Note Date</th>
                <th class="min-w-150px" style="text-align: center;">Product Name</th>
        ...
        <tbody>
            ...
            @foreach ($data as $data)
                <tr>
                    <td>1</td>
                    <td>DO 24/11/0024</td>
                    <td>J/H/24/10-0671</td>
                    <td>01/11/2024</td>
                    <td>Yummy Yoghurt Natural</td>
                    <td>6pcs</td>
                    <td>Rp30.630,60</td>
                    <td>Rp30.630,60</td>
                </tr>
                ...
                <td colspan="6" rowspan="6"
                    ...
                    <div style="width: 50%; margin-top: 20px;">
                        <div style="text-align: center;">
                            ...
                            <img class="mb-4" src="{{ asset('assets/media/svg/brand-logos/google-icon.svg') }}"
                                alt="" height="80">
                        </div>
