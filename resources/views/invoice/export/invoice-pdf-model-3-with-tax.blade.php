...
<div class="content">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>Sub Total</td>
            <td style="text-align: right">{{\App\Utils\Util::rupiah($invoice->calculate($ppn)['sub_total'],false,true,true)}}</td>
        </tr>
        <tr>
            <td>Discount</td>
            <td style="text-align: right">{{\App\Utils\Util::rupiah($invoice->calculate($ppn)['discount_total'],false,true,true)}}</td>
        </tr>
        <tr>
            <td>DPP</td>
