...
class Indonesia extends Seeder
{
    /**
    ...
    {
        $file_prov = 'database/seeders/indonesia/provinsi.json';
        $file_kab = 'database/seeders/indonesia/kabupaten.json';
        $file_kec = 'database/seeders/indonesia/kecamatan.json';
        $file_kel = 'database/seeders/indonesia/kelurahan.json';
        ...
        DB::table('districts')->insert($data_kab);
        ...
        foreach ($chunk_kec as $key => $chunk) {
            ...
            DB::table('sub_districts')->insert($chunk);
        ...
        foreach ($chunk_kel as $key => $chunk) {
            ...
            DB::table('sub_district_villages')->insert($chunk);
