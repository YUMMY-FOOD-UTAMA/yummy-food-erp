...
class Toolbar extends Component
{
     ...
     */
    public function __construct($modalSize = "1000", $name = 'data', $routeCreateName = null, $routeTrashName = null, $routeListName = null, $headingName = null, $usingCreateModal = false)
    {
        $this->name = $name;
